...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i737.CartDataSourceInterface>(() => _i700.CartDataSourceImp());
    ...
    gh.factory<_i198.CartRepoInterface>(
      () => _i623.CartRepoImp(
        cartDataSource: gh<_i737.CartDataSourceInterface>(),
      ),
    );
    ...
    gh.factory<_i605.AddCartUseCase>(
      () => _i605.AddCartUseCase(cartRepo: gh<_i198.CartRepoInterface>()),
    );
    gh.factory<_i70.DeleteCartUseCase>(
      () => _i70.DeleteCartUseCase(cartRepo: gh<_i198.CartRepoInterface>()),
    );
    gh.factory<_i640.GetCartUseCase>(
      () => _i640.GetCartUseCase(cartRepo: gh<_i198.CartRepoInterface>()),
    );
    ...
    gh.factory<_i383.CartCubit>(
      () => _i383.CartCubit(
        getCartUseCase: gh<_i640.GetCartUseCase>(),
        addCartUseCase: gh<_i605.AddCartUseCase>(),
        deleteCartUseCase: gh<_i70.DeleteCartUseCase>(),
      ),
    );
